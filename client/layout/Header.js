...
class Header extends Component {
  ...
  render() {
    ...
    if (auth.user.image == null) var profile_img = profileplaceholder;
    else var profile_img = auth.user.image; //API_URL.API_URL+'/public/'+auth.user.id+'/profile/'+auth.user.image;
      ...
      <header>
        <div className="main clearfix">
          ...
          <div className="fright">
            ...
            {auth.isAuthenticated && (
              <div className="login inline-block">
                <div className="imageHolder inline-block">

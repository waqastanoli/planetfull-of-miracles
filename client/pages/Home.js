...
class Home extends Component {
  ...
  showsSuccessAlert = (heading, message) => {
    const getAlert = () => (
      <SweetAlert success title={heading} onConfirm={() => this.hideAlert()}>
        {message}
      </SweetAlert>
    );
  ...
  render() {
    ...
    if (profile.image == null) var profile_img = profileplaceholder;
    else var profile_img = profile.image;
    //var profile_img = API_URL.API_URL+'/public/'+profile.id+'/profile/'+profile.image;
    if (profile.cover == null) var cover_img = placeholdercover;
    else var cover_img = profile.cover; //API_URL.API_URL+'/public/'+profile.id+'/cover/'+profile.cover;
        ...
        {profile.fetched && (
          <main className={"main " + (logged_in ? "logged_in" : "")}>
              ...
              <div className="imagearea">
                ...
                <div className="profileS">
                  <div
                    ...
                    onClick={e => this.handleShow("profile", e)}
                  >
                    <img
                      src={profile_img}
                      alt="image"
                  ...
                  {logged_in && (
                    <div className="editcover">
                      <a
                        onClick={e => this.handleShow("cover", e)}
                        title="Edit Cover"
                      >
                        {" "}
                        <span className="sprite icon"></span> Edit Cover
                      </a>
                    </div>
                  )}
                </div>
                ...
                <ul className="clearfix">
                  <li className="Current">
                    ...
                    <div className="right fleft">
                      <div className="num fleft">
                        {profile.openContracts.length}
                      </div>
                      <div className="text fleft">
                        Open
                        <div>Contracts</div>
                      </div>
                    </div>
                  ...
                  <li className="Completed">
                    ...
                    <div className="right fleft">
                      <div className="num fleft">
                        {profile.completedContracts.length}
                      </div>
                      <div className="text fleft">
                        Completed
                        <div>Contracts</div>
                ...
                <ImagesUploader
                  ...
                  onLoadEnd={(err, img_res) => {
                    ...
                    if (img_res.length) {
                      ...
                      } else profile.cover = img_res[0]; //splited_res[splited_res.length-1]
                    }
                  }}
                  label=""
                  multiple={false}
            ...
            <div className="clearfix">
              <Modal
                show={this.state.topicshow}
                className="proud_modal"
                onHide={this.topichandleClose}
              >
                <span className="close" onClick={this.topichandleClose}>
                  close{" "}
                </span>
                <Modal.Header>
                  <Modal.Title>
                    <h2>
                      {actions.topic} {topic.type} Topic
                    </h2>
                  </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                  <div
                    className={"form-input" + (errors.text ? " has-error" : "")}
                  >
                    <label>
                      <input
                        value={topic.text}
                ...
                <Modal.Footer>
                  <Button variant="secondary" onClick={this.topichandleClose}>
                    Close
                  </Button>
                  &nbsp;&nbsp;
                  <Button variant="primary" onClick={this.topichandleSave}>
                    Save
                  </Button>
                </Modal.Footer>
              </Modal>
                ...
                {logged_in && (
                  <div className="sideBtn">
                    <div className="addButton">
                      <a
                        title="ADD"
                        onClick={e => this.topichandleShow("add", e)}
                      >
                        <span data-icon="plus"></span>ADD
                      </a>
                    </div>
                  </div>
                )}
                <div className="toggle tabs tabs_default TabFirst">
                  <ul className="tabs">
                    <li
                      ...
                      onClick={e => this.updatetopichandle("inspire", e)}
                    >
                      <a>Inspire</a>
                    </li>
                    <li
                      className={
                        "tab" + (topic.type == "aspire" ? " active" : "")
                      }
                      onClick={e => this.updatetopichandle("aspire", e)}
                    >
                      <a>Aspire</a>
                    </li>
                  </ul>
                  ...
                  >
                    <ul className="ToptopicList">
                      {profile.inspire
                        .map((inspire, index) => {
                          return (
                            <li key={inspire._id} className="clearfix">
                              <div className="left">
                                <a href="#" title="{inspire.text}">
                                  {inspire.text}
                                </a>
                              </div>
                              <div className="right">
              ...
              <Modal
                show={this.state.proudshow}
                className="proud_modal"
                onHide={this.proudhandleClose}
              >
                <span className="close" onClick={this.proudhandleClose}>
                  close{" "}
                </span>
                <Modal.Header>
                  <Modal.Title>
                    <h2>{actions.proud} Proud</h2>
                  </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                  <div
                    className={
                      "form-input" + (errors.title ? " has-error" : "")
                    }
                  >
                    <label>
                      <input
                  ...
                  <div
                    className={"form-input" + (errors.note ? " has-error" : "")}
                  >
                    <label>
                      <textarea
                        onChange={this.handleChange}
                      ...
                      />
                      {errors.note != "" && (
                        <div style={{ top: "120px" }} className="help-block">
                          {" "}
                          {errors.note}
                        </div>
                      )}
                ...
                <Modal.Footer>
                  <Button variant="secondary" onClick={this.proudhandleClose}>
                    Close
                  </Button>
                  &nbsp;&nbsp;
                  <Button variant="primary" onClick={this.proudhandleSave}>
                    Save
                  </Button>
                </Modal.Footer>
              </Modal>
                  ...
                  {logged_in && (
                    <div className="sideBtn">
                      <div className="addButton">
                        <a
                          title="ADD"
                          onClick={e => this.proudhandleShow("add", e)}
                        >
                          <span data-icon="plus"></span>ADD
                        </a>
                      </div>
                      ...
                      .map((proud, index) => {
                        return (
                          <li key={proud._id}>
                            <div className="date">
                              <span className="sprite icon"></span>
                              <Moment format="D MMMM, HH:mm">
                                {proud.createdAt}
                              </Moment>{" "}
                            </div>
                            <h3>
                              <a href="#" title={proud.title}>
                                {proud.title}
                              </a>
                            </h3>
                            <p>{proud.note}</p>
                            <span className="proud_actions">
                              {logged_in && (
                                <a
                                  onClick={e =>
                                    this.proudhandleShow("edit", proud, e)
                                  }
                                  title="EDIT"
                                >
                                  EDIT
            ...
            <section className="Contracts shadowbox">
              ...
              {logged_in && (
                <div className="sideBtn">
                  <div className="addButton">
                    <a
                      title="ADD"
                      onClick={e => this.contracthandleShow("add", e)}
                    >
                      <span data-icon="plus"></span>ADD
                    </a>
                  </div>
              ...
              <div className="toggle tabs tabs_default TabSecond">
                <ul className="tabs">
                  <li
                    className={"tab" + (contract.type == "me" ? " active" : "")}
                    onClick={e => this.updatecontracthandle("me", e)}
                  >
                    <a>Serving Me</a>{" "}
                  </li>
                  <li
                    className={
                      "tab" + (contract.type == "others" ? " active" : "")
                    }
                    onClick={e => this.updatecontracthandle("others", e)}
                  >
                    <a>Serving Others</a>
                  </li>
                </ul>
                ...
                <div
                  id="tab-3"
                  className={
                    "scroll " + (contract.type == "me" ? "tab-list-active" : "")
                  }
                >
                    ...
                    <tbody>
                      {profile.serving_me
                        .map((serving, index) => {
                          ...
                          else var profile_img = serving.who.image; //API_URL.API_URL+'/public/'+serving.who._id+'/profile/'+serving.who.image;
                  ...
                  {/* <div className="viewAll"><a href="viewAlllink">view all</a></div>*/}
                </div>
                <div
                  id="tab-4"
                  className={contract.type == "others" ? "tab-list-active" : ""}
                >
                  <table className="contable">
                    <thead>
                      <tr>
            ...
            {isMobile && (
              <div className="topbanner margiVertical0">
            ...
            <Modal
              show={this.state.contractshow}
              className="proud_modal contractform"
              onHide={this.contractClose}
            >
              <span className="close" onClick={this.contractClose}>
                close{" "}
              </span>
              <Modal.Header>
                <Modal.Title>
                ...
                >
                  ...
                  <label>
                    <input
                      type="radio"
                      value="Completed"
                      checked={contract.status === "Completed"}
                      onChange={this.handleOptionChange}
                    />
                    &nbsp; Completed
                  </label>
                ...
                >
                  <label>
                    ...
                    <Select
                      ...
                      onChange={this.handleContractwho}
                    />
              ...
              <Modal.Footer>
                <Button variant="secondary" onClick={this.contractClose}>
                  Close
                </Button>
                &nbsp;&nbsp;
                <Button variant="primary" onClick={this.contracthandleSave}>
                  Save
                </Button>
              </Modal.Footer>
            </Modal>

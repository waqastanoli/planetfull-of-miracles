...
import joe from "../../public/jocallio/image/Advisory/joe-revised.png";
                  ...
                  <div className="vc_column-inner ">
                    <div className="wpb_wrapper">
                      <div className="wpb_text_column wpb_content_element ">
                        <div className="wpb_wrapper">
                          <p>
                            <strong>C. L. Morci, Founder</strong>
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="wpb_text_column wpb_content_element ">
                        <div className="wpb_wrapper">
                          <p>
                            Combines the forces of TV and Internet to create
                            opportunity and outcomes. Monetize your skills: Pay
                            it forward.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="vc_column-inner ">
                    <div className="wpb_wrapper">
                      <div className="wpb_text_column wpb_content_element ">
                        <div className="wpb_wrapper">
                          <p>
                            <strong>Christopher Lemmon</strong>
                          </p>
                        </div>
                      </div>
                      <div className="wpb_single_image wpb_content_element vc_align_left">
                      ...
                      <div className="wpb_text_column wpb_content_element ">
                        <div className="wpb_wrapper">
                          <p>
                            Multi-talented actor, author, musician and producer
                            (son of Jack Lemmon)
                          </p>
                        </div>
                      </div>
